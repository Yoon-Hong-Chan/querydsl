...
//        }
    ...
    private List<Member> searchMemeber1(String usernameCond, Integer ageCond) {
    ...
    private List<Member> searchMemeber2(String usernameCond, Integer ageCond) {
        return queryFactory
                .selectFrom(member)
                .where(searchCond(usernameCond,ageCond))
                .fetch();
    }
    ...
    private BooleanExpression searchCond(String usernameCond, Integer ageCond){
